...
- [StarRocks](https://starrocks.io) - StarRocks is a next-gen sub-second MPP database for full analytics scenarios, including multi-dimensional analytics, real-time analytics and ad-hoc query. ([Source Code](https://github.com/StarRocks/starrocks/) `Apache-2.0` `Docker`
